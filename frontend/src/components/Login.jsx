...
function Login() {
    ...
    return <div class="flex flex-col gap-2 min-h-screen items-center justify-center px-4 text-center md:gap-4 bg-[#2B60C2] md:bg-[#f3f4f6]">
                <div className="md:bg-[#2B60C2] p-28 rounded-md">
                    ...
                    <button class="text-white inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 mx-auto w-full" >
                    Login with Google
                    </button>
                    </div>                    
                </div>
