        ...
        <div class="container grid max-w-6xl h-min items-center gap-6 px-4 space-y-6 lg:gap-10 lg:px-6">
            <div class="space-y-2">
                ...
                <p class="text-gray-500 dark:text-gray-400">
                    ...
                    <a class="underline ml-4" href="/signin">
                        Sign in
                    </a>
                </p>
            </div>
            <div class="border rounded-lg border-gray-200 dark:border-gray-800">
                <div class="p-6 space-y-6">
                    ...
                    <button onClick={handleSignup} class="inline-flex text-white items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full" style={{ backgroundColor: "rgb(43, 96, 194)" }}>
                        Sign up
                    </button>
                </div>
            </div>
